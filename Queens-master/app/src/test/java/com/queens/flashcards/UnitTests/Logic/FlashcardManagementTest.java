...
public class FlashcardManagementTest {
    ...
    @Before
    public void setUp() {
        flashcardManagementService = new FlashcardManagementService(TestServices.getFlashcardPersistence(),
                                                                    TestServices.getFcPersistence(),
                                                                    TestServices.getFaTextPersistence(),
                                                                    TestServices.getFaTrueFalsePersistence(),
                                                                    TestServices.getFaMultipleChoicePersistence(),
                                                                    TestServices.getFlashcardValidator(),
                                                                    TestServices.getAnswerValidator());
    ...
    public void tearDown() {
        for (Flashcard f : flashcardManagementService.getAllFlashcards())
    ...
    public void testFlashcardWithInvalidMCWrong() throws EmptyNameException, EmptyQuestionException, EmptyAnswerException, DuplicateNameException {
        Flashcard f = new Flashcard("Name", "Question", new FlashcardMCAnswer("Yay", new ArrayList<String>(){{add("");}}));
